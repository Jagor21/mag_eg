...
class MagicEgyptFCMService: FirebaseMessagingService() {


    companion object {
        const val CHANNEL_ID = "magic_egypt_channel_id"
        const val SILENT_CHANNEL_ID = "magic_egypt_silent_channel_id"
    }
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        try {
            ...
            Log.d("MagicEgyptFCMService", e.message.toString())
        }
    }
